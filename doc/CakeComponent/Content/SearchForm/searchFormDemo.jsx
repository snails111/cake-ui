...
const propsConfig = [
    ...
    },
    {
      key: "resetType",
      param: "resetType",
      explain: "1：重置后自动查询（默认，点击重置执行search方法，参数为初始参数）  2：重置后不自动查询",
      type: "number",
      defaultValue: "1"
    },  
    {
...
const configData = [
  {
    ...
    explain: "配置类型",
    type: "string",
    defaultValue: "text、number、switch、radio、radioTag、select、selectTree、date、dateRange、custom"
  },
  {
    key: "keyName",
    param: "keyName",
  ...
  render() {
    const searchConfig=[
      ...
      },
      {
        ...
        endKeyName: "endTime",
        format: "YYYY-MM-DD HH:mm:ss",
        showTime: {defaultValueue: [moment('00:00:00', 'HH:mm:ss'), moment('23:59:59', 'HH:mm:ss')], format: 'HH:mm:ss'},
        colSpan: 8,
        mdColSpan: 10,
        smColSpan: 10,
        xsColSpan: 16,
